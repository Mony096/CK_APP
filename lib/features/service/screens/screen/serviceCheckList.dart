                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      context.read<CompletedServiceProvider>().checkListLine.isNotEmpty
                          ? Container()
                          : Container(
                              height: 90,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 13,
                                          color: Color.fromARGB(255, 122, 126, 150)),
                                      textScaleFactor: 1.0,
                                    ),
                                  ],
                                ),
                        ...
                        (entry) {
                          ...
                          return StatefulBuilder(
                            builder: (context, setState) {
                              ...
                              return DetailMenu(
                                onEditFeedback: () => _showEditFeedback(item, index),
                                ...
                                icon: Padding(
                                  ...
                                  child: Checkbox(
                                    ...
                                    onChanged: (bool? value) {
                                      ...
                                      debugPrint("Checkbox at index $index changed to $value");
                                    },
                                  ),
                                ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Icon(Icons.keyboard_arrow_down, size: 24, color: Colors.blueGrey.shade400)
        ],
      ),
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: GestureDetector(
              onTap: widget.onTap,
              child: Container(
                color: Colors.transparent, // transparent for click area
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
