...
import 'package:bizd_tech_service/features/service/presentation/components/detail_row.dart';
import 'package:bizd_tech_service/features/service/presentation/components/row_item.dart';
...
class __ServiceByIdScreenState extends State<ServiceByIdScreen> {
  ...
  Future<void> _onReject() async {
    ...
    try {
      ...
      //   status: "Open",
      //   context: context, // âœ… Corrected here
      // );
                                          ...
                                          Flexible(
                                            child: Text(
                                              ...
                                              overflow: TextOverflow
                                                  .ellipsis, // â¬…ï¸ important
                                              maxLines:
                                                  1, // â¬…ï¸ keep it one line
                                            ),
                                          ),
                                        ],
                                      )
