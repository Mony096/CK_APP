...
import 'package:bizd_tech_service/shared/widgets/text_time_dialog.dart';
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            "Travel Time",
                            style: TextStyle(fontSize:  MediaQuery.of(context).size.width * 0.036, color: Colors.black),
                          ),
                          SizedBox(
                            width: 5,
                          ),
        ...
        children: [
          ...
          Expanded(
              ...
              child: Text(
                ...
                widget.title,
                style:
                     TextStyle(fontWeight: FontWeight.bold, fontSize:  MediaQuery.of(context).size.width * 0.032),
              )),
          Expanded(
              flex: 3,
              child: Padding(
