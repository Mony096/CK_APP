import 'dart:async';
import 'package:bizd_tech_service/shared/widgets/DateForServiceList.dart';
import 'package:bizd_tech_service/shared/widgets/DatePickerDialog.dart';
import 'package:bizd_tech_service/core/utils/helper.dart';
...
import 'package:bizd_tech_service/features/service/presentation/components/block_service.dart';
import 'package:bizd_tech_service/features/service/presentation/screens/sericeEntry.dart';
import 'package:bizd_tech_service/features/service/presentation/screens/serviceById.dart';
...
class _ServiceScreenState extends State<ServiceScreen> {
  ...
  Future<void> onUpdateStatus(entry, currentStatus) async {
    ...
    try {
      // â³ Wait 1 seconds before updating
      ...
      //âœ… Close loading after update
    } catch (e) {
      Navigator.of(context).pop(); // Close loading
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('âŒ Error: $e')),
      );
    }
  }
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          ...
                          if (_dateController.text.isNotEmpty) {
                            ...
                            provider.loadDocuments(); // âœ… apply filter
                          }
                        },
